# ตัวกรองเกาส์เซียน (Gaussian Filter)
# ใช้สำหรับลดเสียง (Noise Reduction)
...
titles = ['Original Image', 'Filter 2D', 'Mean', 'Median' , 'Gaussian']
images = [img, filter2D, mean, median , gblur]
