...
cap = cv.VideoCapture('C:\Python\Python OpenCV\image\TestVideo (online-video-cutter.com).mp4')
#camera = PiCamera() # ใช้กับ Raspberry Pi 3 และ PiCamera v2 
##camera.resolution = (160,120) # กำหนดความละเอียดของกล้อง ความกว้าง 160 และความสูง 120 พิกเซล 
##camera.framerate = 5 # กำหนดความถี่ของการถ่ายภาพ 5 ภาพต่อวินาที
##rawCapture = PiRGBArray(camera, size=(160,120)) # กำหนดขนาดของภาพที่จะถ่าย ความกว้าง 160 และความสูง 120 พิกเซล 
##time.sleep(0.1) # ใช้เพื่อให้กล้องถ่ายภาพได้เริ่มต้น และเตรียมตัวไว้ก่อน หน่วงเวลา 0.1 วินาที 
##cap.set(3,160) #Width กำหนดความกว้างของภาพ 160 พิกเซล
##cap.set(4,120) #Height กำหนดความสูงของภาพ 120 พิกเซล
...
frameArea = h*w # คำนวณพื้นที่ของภาพ 307,200 พิกเซล  areaTH = 1228 พิกเซล # กำหนดพื้นที่ขั้นต่ำที่จะนับว่ามีคนผ่านเข้ามาในพื้นที่ 1228 พิกเซล # เริ่มต้นการตั้งค่าการตรวจจับคนเดินเข้ามาในพื้นที่  
areaTH = frameArea/500 # คือการกำหนดพื้นที่ของภาพที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ frameArea/250 คือการหารพื้นที่ของภาพ โดยใช้ค่าของความกว้างและความสูงของภาพ และนำค่าที่ได้มาหาร 250 คือค่าที่กำหนดไว้ว่า ถ้าพื้นที่ของภาพน้อยกว่า 250 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าพื้นที่ของภาพมากกว่า 250 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ
print( 'Area Threshold', areaTH) # คือการแสดงค่าของพื้นที่ที่กำหนดไว้ใน areaTH  

#อินพุต/เอาต์พุต
line_up = int(2*(h/5))  #  lineup =192 คือการกำหนดค่าของเส้นที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ int(2*(h/5)) คือการหารความสูงของภาพ โดยใช้ค่าของความสูงของภาพ และนำค่าที่ได้มาหาร 5 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 5 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 5 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ และนำค่าที่ได้มาคูณ 2 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 2 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 2 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ
line_down   = int(3*(h/5)) # linedown= 288 คือการกำหนดค่าของเส้นที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ int(3*(h/5)) คือการหารความสูงของภาพ โดยใช้ค่าของความสูงของภาพ และนำค่าที่ได้มาหาร 5 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 5 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 5 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ และนำค่าที่ได้มาคูณ 3 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 3 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 3 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ

up_limit =   int(1*(h/5)) #  uplimit = 96 คือการกำหนดค่าของเส้นที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ int(1*(h/5)) คือการหารความสูงของภาพ โดยใช้ค่าของความสูงของภาพ และนำค่าที่ได้มาหาร 5 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 5 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 5 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ และนำค่าที่ได้มาคูณ 1 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 1 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 1 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ
down_limit = int(4*(h/5)) #  downlimit = 384 คือการกำหนดค่าของเส้นที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ int(4*(h/5)) คือการหารความสูงของภาพ โดยใช้ค่าของความสูงของภาพ และนำค่าที่ได้มาหาร 5 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 5 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 5 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ และนำค่าที่ได้มาคูณ 4 คือค่าที่กำหนดไว้ว่า ถ้าความสูงของภาพน้อยกว่า 4 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าความสูงของภาพมากกว่า 4 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ
...
pt2 =  [w, line_down]; # คือการกำหนดจุดสิ้นสุดของเส้นที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ w=480
...
##    rawCapture.truncate(0) # คือการกำหนดค่าให้ตัวแปร rawCapture มีค่าเท่ากับ rawCapture.truncate(0) 
    ...
    if k == 27: # คือการกำหนดค่าให้ตัวแปร k มีค่าเท่ากับ 27
        break # คือการออกจากการทำงานของโปรแกรม
#END while(cap.isOpened()) # คือการกำหนดค่าให้ตัวแปร cap.isOpened() มีค่าเท่ากับ True
    
#################
#  การทำความสะอาด   #
#################
log.flush() # คือการกำหนดค่าให้ตัวแปร log มีค่าเท่ากับ log.flush()
log.close() # คือการกำหนดค่าให้ตัวแปร log มีค่าเท่ากับ log.close() 
