...
cap = cv.VideoCapture('C:\Python\Python OpenCV\image/a9.mp4')
...
areaTH = frameArea/238 # คือการกำหนดพื้นที่ของภาพที่จะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ โดยใช้ frameArea/250 คือการหารพื้นที่ของภาพ โดยใช้ค่าของความกว้างและความสูงของภาพ และนำค่าที่ได้มาหาร 250 คือค่าที่กำหนดไว้ว่า ถ้าพื้นที่ของภาพน้อยกว่า 250 คือจะนับว่ามีคนเข้ามาในพื้นที่นั้นๆ และถ้าพื้นที่ของภาพมากกว่า 250 คือจะนับว่าไม่มีคนเข้ามาในพื้นที่นั้นๆ
